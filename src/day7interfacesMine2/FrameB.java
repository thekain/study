 ...
 * @author cnp.ak
 */
public class FrameB extends javax.swing.JFrame implements TransportInterface {
    
    TransportInterface newTIA;
    /**
    ...
    public FrameB(FrameA windowA) {
        initComponents();
        this.newTIA = (TransportInterface) windowA;
    }
